...
void GPIO_Init( GPIO_Handle_t *pGPIOHandle )
{
	...
	// 3. Pull_Up/Down ayarlamalarını yap.
	...
	if( pGPIOHandle->GPIO_PinConfig.GPIO_PinMode == GPIO_MODE_ALTFUN )
	{
		...
		pGPIOHandle->pGPIOx->AFR[ temp1 ] &= ~( 0xF << temp2 );									// ilgili register bölümünü temizle.
		pGPIOHandle->pGPIOx->AFR[ temp1 ] |= temp;												// ilgili register bölümünü ayarla.
		temp1 = 0;
		temp2 = 0;
		temp = 0;
	}
